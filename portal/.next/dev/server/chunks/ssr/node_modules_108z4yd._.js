...
const createKyselyAdapter = async (config)=>{
    ...
    if ("fileControl" in db) {
        const { BunSqliteDialect } = await __turbopack_context__.A("[project]/node_modules/@better-auth/kysely-adapter/dist/bun-sqlite-dialect-na--YwnN.mjs [app-rsc] (ecmascript, async loader)");
    ...
    if ("batch" in db && "exec" in db && "prepare" in db) {
        const { D1SqliteDialect } = await __turbopack_context__.A("[project]/node_modules/@better-auth/kysely-adapter/dist/d1-sqlite-dialect-C2B7YsIT.mjs [app-rsc] (ecmascript, async loader)");
...
"[project]/node_modules/@better-auth/drizzle-adapter/dist/index.mjs [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const createCustomAdapter = (db, inTransaction = false)=>({ getFieldName, getDefaultFieldName, options })=>{
            ...
            const withReturning = async (model, builder, data, where)=>{
                ...
                if (where?.length) {
                    ...
                    return (await db.select().from(schemaModel).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["eq"])(schemaModel.id, tId)).limit(1).execute())[0];
                } else if (data.id) return (await db.select().from(schemaModel).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["eq"])(schemaModel.id, data.id)).limit(1).execute())[0];
                else {
                    ...
                    return (await db.select().from(schemaModel).orderBy((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$select$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["desc"])(schemaModel.id)).limit(1).execute())[0];
                }
            };
                ...
                async findOne ({ model, where, select, join }) {
                    ...
                    if (options.experimental?.joins) {
                        ...
                        if (!db.query || !queryModel) {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$env$2f$logger$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].info("Falling back to regular query");
                        } else {
                            let includes;
                ...
                async consumeOne ({ model, where }) {
                    ...
                    if (config.provider === "mysql") {
                        const claimFromTransaction = async (tx)=>{
                            ...
                            const delRes = await tx.delete(schemaModel).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["eq"])(idColumn, targetId)).execute();
...
//# sourceMappingURL=node_modules_108z4yd._.js.map